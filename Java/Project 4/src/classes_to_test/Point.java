...
public class Point {
     ...
     *
     * @param p - the point object which is going to be copied
     */
    ...
    /**
     * Calculates the distance between to Point objects using the mathmateical
     * formula to do so
     *
     * @param p - the point object which will be evaluated against the point
     * object being called on to calculate the distance between those two points
    ...
    /**
     * A toString method for the Point object Prints out a nice formatted string
     */
    @Override
