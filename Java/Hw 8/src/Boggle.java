...
/**
 * This is the boggle class which does most of the work
 * It creates the gui holds the recursive methods to read
 * what words are in the tray, initilizes the dice, and rolls them
 * RECURSION METHOD TAKES ABOUT A MINUTE TO FIND ALL WORDS
...
public class Boggle extends javax.swing.JFrame {
	...
	/**
	 * This creates a new boggle form as well as anitialize all the dice in the game
	 */
	public Boggle() {
		initComponents();
	...
	/**
	 * The main recursive method where all the magic happens.
	 * It finds all the possible words in the current boggle tray
	 * THE RECURSION METHOD TAKES APPROXIMATELY A MINUTE FOR ALL
	 * WORDS TO BE FOUND
	...
	/**
	 * Method to read in the dictionary text and assign it to
	 * all the words to the arrayList dictionary
	 * THE RECURSION METHOD TAKES APPROXIMATELY A MINUTE FOR ALL
	 * WORDS TO BE FOUND
	...
	/**
	 * This sets up the recursive method, does the method on all spaces
	 * to find each wiord beginning with that space also creates the 
	 * "prefix" dictionaries which are used in the above method
	 * @throws FileNotFoundException
	 **/
	...
	/**
	 * Action Listener for button one the Boggle Button
	 * It puts all the dice values in their place in the gui
	...
	/**
	 * This is the action listener for the find words button
	 * this initializes a new window and displays the words that
	 * AFTER BUTTON IS PUSHED IT TAKE APROXIMATELY A MINUTE FOR RECURSION
	 * METHOD TO FIND ALL WORDS IN TRAY AND DISPLAY IN TEXT AREA
	 * were found in that window
	 * @param evt
	 */
