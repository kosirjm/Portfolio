...
% TODO ADD Throughput = NUMBER DEPARTURES/ SIM TIME = Packets/Sec
% THEORETICAL THROUGHPUT = mu for server time queue = 1/AveTimeInQueue
...
speed = 1000; % Speed up simulation (Can't go above 1000 do to cpu speed limitations)
lambda = 8 * speed ;
mu = 5 * speed;
ro = lambda/mu;
...
simTime = (toc(timerVal)-packet(dataStart,1));
samples = simTime/interval;
...
aveNumProcessing1 = processing1/samples;
aveNumProcessing2 = processing2/samples;
aveNumSystem1 = aveNumInQueue1 + aveNumProcessing1;
aveNumSystem2 = aveNumInQueue2 + aveNumProcessing2;

% Simulated throughput calculations for both servers
throughQueue1 = 1/aveTimeInQueue1;
throughQueue2 = 1/aveTimeInQueue2;
throughProc1 = 1/aveTimeProcessing1;
throughProc2 = 1/aveTimeProcessing2;
through1 = 1/aveTimeInSystem1;
through2 = 1/aveTimeInSystem2;

% Simulated throughput calculations for total system
throughQueue = throughQueue1 + throughQueue2;
throughProcessing = throughProc1 + throughProc2;
throughput = through1 + through2;

% Entire systems average numbers
aveNumInQueue = aveNumInQueue1 + aveNumInQueue2;
aveNumProcessing = aveNumProcessing1 + aveNumProcessing2;
aveNumTotal = aveNumSystem1 + aveNumSystem2;
utilization = aveNumProcessing/numServers;
...
simulated1 = [aveTimeInQueue1 aveTimeInSystem1 aveNumInQueue1 ...
    aveNumSystem1 throughQueue1 throughProc1 through1 utilization P01...
    (ro*(serverProb/10)) blockingProb1];
...
simulated2 = [aveTimeInQueue2 aveTimeInSystem2 aveNumInQueue2...
    aveNumSystem2 throughQueue2 throughProc2 through2 utilization P02...
    (ro*(1-(serverProb/10))) blockingProb2];
...
theoretical(9) = theoretical1(9) * theoretical2(9);
theoretical(11) = theoretical(11)/2;
simulated = [aveTimeInQueue aveTimeInSystem aveNumInQueue aveNumTotal...
    throughQueue throughProcessing throughput utilization P0 ro...
    blockingProbabilityTotal];
